...
public class JSONUtils {
	...
	public static String getStudentInfoJson(StudentInfo studentInfo) throws JSONException {
	...
	public static String getReportCardJson(List<ReportCartItem> reportCard) throws JSONException {
		JSONObject json = new JSONObject();
	...
	public static String getTimeTableJson(List<TimeTableItem> timeTable) throws JSONException {
		JSONObject json = new JSONObject();
		JSONArray jsonArray = new JSONArray();
		json.put("data", jsonArray);
