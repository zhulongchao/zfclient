...
public class HTMLUtils {
	...
	public static String getEventValidation(Document document){
		Elements elements = document.getElementsByTag("input");
		for (int i = 0; i < elements.size(); i++) {
			Element element = elements.get(i);
			if (element.attr("name").equals("__EVENTVALIDATION")) {
				return element.attr("value");
			}
		}
		return null;
	...
	public static String getViewstategenerator(Document document){
		Elements elements = document.getElementsByTag("input");
		for (int i = 0; i < elements.size(); i++) {
			Element element = elements.get(i);
